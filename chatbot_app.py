...
Original file is located at
    https://colab.research.google.com/drive/1o3JPXuqhQryLE5J2N15aGU4TxIN6oxBa
"""
...
--------------------------------------------
End-to-end chatbot using Streamlit for UI.
"""
...
if user_input:
    response = recommend_and_explain(user_input,model,rag,cards_df,X_columns)
